                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="student_name" type="text" class="form-control @error('student_name') is-invalid @enderror" name="student_name" value="{{old('student_name')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="student_roll" type="number" class="form-control @error('student_roll') is-invalid @enderror" name="student_roll" value="{{old('student_roll')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="student_phone" type="text" class="form-control @error('student_phone') is-invalid @enderror" name="student_phone" value="{{old('student_phone')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="student_email" type="email" class="form-control @error('student_email') is-invalid @enderror" name="student_email"value="{{old('student_email')}}" >
