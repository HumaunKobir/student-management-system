...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Sub Category') }}
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <form action="{{route('subcatagori.store')}}" method="post" >
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="catagori" type="text" class="form-control @error('subcatagori_name') is-invalid @enderror" name="subcatagori_name"value="{{old('subcatagori_name')}}" >
